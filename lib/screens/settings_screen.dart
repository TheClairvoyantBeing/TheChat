...
class SettingsScreen extends StatefulWidget {
  ...
  Future<void> _saveSettings() async {
    ...
    // Save other settings if UI added
    await _settings.save(); // HiveObject save
    // Or storage.saveSettings(_settings);
          ...
          ListTile(
             ...
             trailing: Switch(
               ...
               onChanged: (val) {
                 ...
                 _saveSettings();
                 // Note: Theme update requires restart or robust theme provider
                 ScaffoldMessenger.of(context).showSnackBar(
